...
import labImageUrl from "@assets/generated_images/Arbora_research_lab_workspace_ca4c4582.png";
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url(${labImageUrl})`,
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="backdrop-blur-sm bg-card/50 border-white/10">
            ...
            <CardContent className="text-sm text-muted-foreground">
              Meet the diverse team of researchers, practitioners, and AI specialists behind our innovations.
            </CardContent>
          </Card>
