    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{ paddingTop: '88px', paddingBottom: '128px' }}>
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 mb-8">
          ...
          <span className="text-sm text-muted-foreground">Transforming Conflict Into Connection</span>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text">
          Turn Every Conversation Into Sacred Practice
        </h1>

        <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-3xl mx-auto leading-relaxed">
          Stop the cycle where good intentions dissolve into conflict. Learn a framework that transforms daily interactions into moments of genuine connection and spiritual growth.
        </p>

        <p className="text-lg text-muted-foreground/80 mb-12 max-w-2xl mx-auto">
          Join Executive Assistants, TEAL startup founders, and Design & Innovation students who are ending communication breakdowns and discovering the peace of conscious dialogue.
        </p>
